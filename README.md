...
A local Whisper AI transcriber bot for Telegram, utilizing a local GPU or CPU for processing. No pay-as-you-go Whisper API access required -- just utilize your locally available hardware.
